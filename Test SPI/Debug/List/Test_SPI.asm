...
; 0000 002C TCNT0=0xB2;
	LDI  R30,LOW(178)
	OUT  0x32,R30
; 0000 002D 
; 0000 002E // Place your code here
; 0000 002F     if (count == 19)
	LDI  R30,LOW(19)
	CP   R30,R7
	BRNE _0x3
; 0000 0030         {
; 0000 0031            btn_flag = 1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0032            count = 0;
	CLR  R7
; 0000 0033            if (click_flag)
	TST  R4
	BREQ _0x4
; 0000 0034             {
; 0000 0035                 click_flag=0;
	CLR  R4
; 0000 0036             }
; 0000 0037             else
	RJMP _0x5
...
; 0000 0049 // Function: Bit7=In Bit6=In Bit5=Out Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=In
; 0000 004A DDRB=(0<<DDB7) | (0<<DDB6) | (1<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(46)
	OUT  0x17,R30
; 0000 004B // State: Bit7=T Bit6=T Bit5=0 Bit4=T Bit3=0 Bit2=1 Bit1=T Bit0=T
; 0000 004C PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (1<<PORTB4) | (0<<PORTB3) | (1<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(20)
	OUT  0x18,R30
; 0000 004D 
; 0000 004E // Port C initialization
; 0000 004F // Function: Bit6=In Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0050 DDRC=(0<<DDC6) | (1<<DDC5) | (1<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(48)
	OUT  0x14,R30
; 0000 0051 // State: Bit6=T Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0056 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0057 // State: Bit7=T Bit6=T Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0058 PORTD=(0<<PORTD7) | (0<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(63)
	OUT  0x12,R30
; 0000 0059 
...
; 0000 005D TCCR0=(1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x33,R30
; 0000 005E TCNT0=0xB2;
	LDI  R30,LOW(178)
	OUT  0x32,R30
; 0000 005F 
...
; 0000 0064 // OC1A output: Toggle on compare match
; 0000 0065 // OC1B output: Disconnected
; 0000 0066 // Noise Canceler: Off
; 0000 0067 // Input Capture on Falling Edge
; 0000 0068 // Timer Period: 1,1364 ms
; 0000 0069 // Output Pulse(s):
; 0000 006A // OC1A Period: 2,2728 ms Width: 1,1364 ms
...
; 0000 006F TCCR1A=(0<<COM1A1) | (1<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(64)
	OUT  0x2F,R30
; 0000 0070 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(9)
	OUT  0x2E,R30
; 0000 0071 TCNT1H=0xDC;
	LDI  R30,LOW(220)
	OUT  0x2D,R30
; 0000 0072 TCNT1L=0x7D;
	LDI  R30,LOW(125)
	OUT  0x2C,R30
...
; 0000 0074 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0075 OCR1AH=0x23;
	LDI  R30,LOW(35)
	OUT  0x2B,R30
; 0000 0076 OCR1AL=0x82;
	LDI  R30,LOW(130)
	OUT  0x2A,R30
...
; 0000 009E // SPI Type: Master
; 0000 009F // SPI Clock Rate: 500,000 kHz
; 0000 00A0 // SPI Clock Phase: Cycle Start
; 0000 00A1 // SPI Clock Polarity: Low
; 0000 00A2 // SPI Data Order: MSB First
; 0000 00A3 SPCR=(0<<SPIE) | (1<<SPE) | (0<<DORD) | (1<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (1<<SPR0);
	LDI  R30,LOW(81)
	OUT  0xD,R30
; 0000 00A4 SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 00A5 
