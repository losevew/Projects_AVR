...
#define LCD_E_OUT					PORTC	/* Output register */
...
#define LCD_RS_OUT					PORTC	/* Output register */
...
#define LCD_D7_OUT					PORTC	/* Output register */
#define LCD_D7_IN					PINC	/* Input register */
#define LCD_D7 	 					5u	/* Pin number */

#define LCD_D6_OUT					PORTC	/* Output register */
#define LCD_D6						4u	/* Pin number */

#define LCD_D5_OUT					PORTC	/* Output register */
#define LCD_D5						3u	/* Pin number */

#define LCD_D4_OUT					PORTC	/* Output register */
#define LCD_D4						2u	/* Pin number */
...
#define BUSY_CYCLE_TIME				10u		/* x 10us. See datasheet for minimal value. */
...
#define PROGRESS_BAR_HEIGHT			6u  /* in pixel: 1(min), 2, 3, 4, 5, 6, 7, 8(max) */
