...
;#include "max7219.h"
	...
	.CSEG
_max7219_init_port:
; .FSTART _max7219_init_port
	SBI  0x17,0
	SBI  0x18,0
	RET
; .FEND
_max7219_out_word:
; .FSTART _max7219_out_word
	ST   -Y,R27
	ST   -Y,R26
;	data -> Y+0
	CBI  0x18,0
...
; .FEND
_max7219_test:
; .FSTART _max7219_test
	LDI  R26,LOW(3841)
	LDI  R27,HIGH(3841)
	RCALL _max7219_out_word
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	RCALL _delay_ms
	LDI  R26,LOW(3840)
...
; 0000 0027 // Function: Bit7=In Bit6=In Bit5=Out Bit4=In Bit3=Out Bit2=Out Bit1=In Bit0=Out
; 0000 0028 DDRB=(0<<DDB7) | (0<<DDB6) | (1<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (0<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(45)
	OUT  0x17,R30
; 0000 0029 // State: Bit7=T Bit6=T Bit5=0 Bit4=T Bit3=0 Bit2=0 Bit1=T Bit0=0
; 0000 002A PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(0)
	OUT  0x18,R30
; 0000 002B 
; 0000 002C // Port C initialization
; 0000 002D // Function: Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 002E DDRC=(0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 002F // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0030 PORTC=(0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 0031 
...
; 0000 003B TCCR0=(0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 005A ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 005B TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0060 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0061 
...
; 0000 0076 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0077 
; 0000 0078 // SPI initialization
; 0000 0079 // SPI Type: Master
; 0000 007A // SPI Clock Rate: 250,000 kHz
; 0000 007B // SPI Clock Phase: Cycle Start
; 0000 007C // SPI Clock Polarity: Low
; 0000 007D // SPI Data Order: MSB First
; 0000 007E SPCR=(0<<SPIE) | (1<<SPE) | (0<<DORD) | (1<<MSTR) | (0<<CPOL) | (0<<CPHA) | (1<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(82)
	OUT  0xD,R30
...
; 0000 0083 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0084 
; 0000 0085 max7219_init(MAX7219_TEST_ON, MAX7219_DECODE, 8);
	LDI  R30,LOW(1)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R26,LOW(8)
	RCALL _max7219_init
; 0000 0086 max7219_clear();
	RCALL _max7219_clear
; 0000 0087 max7219_data_out(2,2,MAX7219_POINT_OFF);
	LDI  R30,LOW(2)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R26,LOW(127)
	RCALL _max7219_data_out
; 0000 0088 max7219_data_out(4,4,MAX7219_POINT_ON);
	LDI  R30,LOW(4)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R26,LOW(128)
