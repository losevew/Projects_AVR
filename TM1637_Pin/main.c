...
// State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=1 Bit0=1 
...
TM1637_set(2,DISPLAY_ON,STARTADDR);// ставим ¤ркость 2 
TM1637_clearDisplay();
delay_ms(200);//не знаю зачем, но тупим немного    
TM1637_display(2,3);
delay_ms(2000);
TM1637_clearDisplay();
TM1637_display_int_decimal(4235);
delay_ms(2000);
TM1637_clearDisplay();
TM1637_display_float_decimal(15.6);
delay_ms(2000);
