...
// Порт и пины управления индикатором

#define CLK 0 //обзываем пины
#define DIO 1
...
//-------------------------------------------------------------------------
        ...
        //unsigned char coding(unsigned char DispData);   
...
void TM1637_writeByte(unsigned char wr_data) // служебна¤ функци¤ записи данных по протоколу I2C, с подтверждением (ACK)
{
    char i;
    for(i=0;i<8;i++)        
    {
