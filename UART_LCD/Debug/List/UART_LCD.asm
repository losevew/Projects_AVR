...
; 0000 0045         glcd_clear();
	RCALL _glcd_clear
; 0000 0046         glcd_outtextf("Œ¯Ë·Í‡ ‰‡ÌÌ˚ı");
	__POINTW2FN _0x0,0
...
; 0000 004C         glcd_clear();
	RCALL _glcd_clear
; 0000 004D         glcd_outtextf("ÕÂÚ ÒË„Ì‡Î‡");
	__POINTW2FN _0x0,14
	RCALL _glcd_outtextf
; 0000 004E 
...
; 0000 0050         glcd_outtextxyf(15,8," —ÔÛÚÌËÍÓ‚ ");
	LDI  R30,LOW(15)
	ST   -Y,R30
	LDI  R30,LOW(8)
	ST   -Y,R30
...
; 0000 0051         glcd_outtextxyf(10,15,"Ó·Ì‡ÛÊÂÌÓ");
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R30,LOW(15)
	ST   -Y,R30
...
; 0000 005E     glcd_putchar (gga_data[search_gga_field(3)]);
	...
	RCALL _glcd_putchar
; 0000 005F 
; 0000 0060     glcd_outtextxyf(0,15,"ƒÓÎ„ÓÚ‡:");
	RCALL SUBOPT_0x4
	LDI  R30,LOW(15)
	ST   -Y,R30
	__POINTW2FN _0x0,57
