...
//	unsigned int H_CAPACITY_FACTOR EEMEM = 394; // Standardwerte fur M8
//	unsigned int L_CAPACITY_FACTOR EEMEM = 283; // Standardwerte fur M8
//	unsigned int H_CAPACITY_FACTOR EEMEM = 250; // Standardwerte fur M8A
//	unsigned int L_CAPACITY_FACTOR EEMEM = 162; // Standardwerte fur M8A

	unsigned int H_CAPACITY_FACTOR EEMEM = 266; // my mega8a
	unsigned int L_CAPACITY_FACTOR EEMEM = 174; // my mega8a
...
#elif defined(RUSSIAN)	// RUSSIAN
//	unsigned char TestRunning[] EEMEM = "Testing ...ÀÀÀÀÀÀ";
	unsigned char TestRunning[] EEMEM = { 0x41,0xBD,0x61,0xBB,0xB8,0xB7,0x2C,0xB6,0xE3,0xB8,0xBF,0x65,0x2E,0x2E,0x2E,0x00 };

//	unsigned char Bat[] EEMEM = "Battery À";
	unsigned char Bat[] EEMEM = { 0x00 };

//	unsigned char BatWeak[] EEMEM = "weakÀÀÀ";
	unsigned char BatWeak[] EEMEM = { 0xA0,0x61,0xBF,0x61,0x70,0x65,0xC7,0x20,0x70,0x61,0xB7,0x70,0xC7,0xB6,0x2E,0x00 };

//	unsigned char BatEmpty[] EEMEM = "empty!ÀÀ";
	unsigned char BatEmpty[] EEMEM = { 0xA4,0x61,0xBC,0x65,0xBD,0xB8,0xBF,0x65,0x20,0xB2,0x61,0xBF,0x61,0x70,0x65,0xC6,0x00 };

//	unsigned char TestFailed1[] EEMEM = "No, unknown, orÀ";
	unsigned char TestFailed1[] EEMEM = { 0x4F,0xBF,0x63,0x79,0xBF,0x63,0xBF,0xB3,0x79,0x65,0xBF,0x20,0xB8,0xBB,0xB8,0x00 };

//	unsigned char TestFailed2[] EEMEM = "damaged ÀÀÀÀ";
	unsigned char TestFailed2[] EEMEM = { 0xBD,0x65,0xB8,0x63,0xBE,0x70,0x2E,0x20,0x00 };

//	unsigned char Bauteil[] EEMEM = "partÀÀÀÀÀÀ";
        unsigned char Bauteil[] EEMEM = { 0x6F,0xB2,0x70,0x61,0xB7,0x65,0xE5,0x20,0x00 };

        unsigned char Bauteil1[] EEMEM = { 0x4F,0xB2,0x70,0x61,0xB7,0x65,0xE5,0x20,0x00 };
	
//      unsigned char Unknown[] EEMEM = " unknownÀ";
	unsigned char Unknown[] EEMEM = { 0xBD,0x65,0xB8,0xB7,0xB3,0x65,0x63,0xBF,0x00 };
	
//      unsigned char Diode[] EEMEM = "Diode: ";
        unsigned char Diode[] EEMEM = { 0xE0,0xB8,0x6F,0xE3,0x3A,0x20,0x00 };

//	unsigned char DualDiode[] EEMEM = "Double diode À";
	unsigned char DualDiode[] EEMEM = { 0xE0,0xB3,0x6F,0xB9,0xBD,0x6F,0xB9,0x20,0xE3,0xB8,0x6F,0xE3,0x20,0x00 };
	
//      unsigned char TwoDiodes[] EEMEM = "2 diodes";
	unsigned char TwoDiodes[] EEMEM = { 0x32,0x20,0xE3,0xB8,0x6F,0xE3,0x61,0x00 };
	
//      unsigned char Antiparallel[] EEMEM = "anti-parallel";
	unsigned char Antiparallel[] EEMEM = { 0xB3,0x63,0xBF,0x70,0x65,0xC0,0xBD,0x6F,0x2D,0xBE,0x61,0x70,0x61,0xBB,0xBB,0x2E,0x00 };
	
//      unsigned char InSeries[] EEMEM = "serial A=ÀÀ";
        unsigned char InSeries[] EEMEM = { 0x63,0x65,0x70,0xB8,0xC7,0x20,0x41,0x3D,0x00 };
	...
	unsigned char K[] EEMEM = "K=";
////
       // unsigned char Om[] EEMEM = { 0x4F,0xBC,0x00 };
	
//      unsigned char Triac[] EEMEM = "Triac";
	unsigned char Triac[] EEMEM = { 0x43,0xB8,0xBC,0xB8,0x63,0xBF,0x6F,0x70,0x00 };

//      unsigned char Thyristor[] EEMEM = "Thyristor";  
        unsigned char Thyristor[] EEMEM = { 0x54,0xB8,0x70,0xB8,0x63,0xBF,0x6F,0x70,0x00 };
	

	#ifdef UseM8
//		unsigned char OrBroken[] EEMEM = "or damaged ÀÀ";
		unsigned char OrBroken[] EEMEM = { 0xB8,0xBB,0xB8,0x20,0xBD,0x65,0xB8,0x63,0xBE,0x70,0x2E,0x20,0x00 };
		
//              unsigned char Resistor[] EEMEM = "Resistor: ÀÀ";
                unsigned char Resistor[] EEMEM = { 0x50,0x65,0xB7,0xB8,0x63,0xBF,0x6F,0x70,0x3A,0x20,0x00 };
//		unsigned char Capacitor[] EEMEM = "Capacitor: ÀÀ";
		unsigned char Capacitor[] EEMEM ={ 0x4B,0x6F,0xBD,0xE3,0x65,0xBD,0x63,0x61,0xBF,0x6F,0x70,0x3A,0x20,0x00 };
	#endif
...
//------------------------------------------
//Sprachunabhôngige EEPROM-Strings
...
unsigned char bstr[] EEMEM = { 0x20,0xA0,0x3D,0x00 };

//unsigned char cstr[] EEMEM = ";C=";
unsigned char cstr[] EEMEM = { 0x3B,0x4B,0x3D,0x00 };

//unsigned char estr[] EEMEM = ";E=";
unsigned char estr[] EEMEM = { 0x3B,0xAF,0x3D,0x00 };

//unsigned char gds[] EEMEM = "GDS=";
unsigned char gds[] EEMEM = { 0xA4,0x43,0xA5,0x3D,0x00 };
...
unsigned char CA[] EEMEM = "OA";
//unsigned char CA[] EEMEM = { 0x4F,0xB2,0x41,0x00};

unsigned char CC[] EEMEM = "OK";
//unsigned char CC[] EEMEM = { 0x4F,0xB2,0x4B,0x00};
