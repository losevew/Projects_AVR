...
TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
 ...
 // »нициализируем светодиодную матрицу
  ledmatrix_init();
  
  // ћигнЄм всеми матрицами (типа тест индикаторов)
...
while (1)
      ...
      // ‘ормируем буфер дл¤ скролла на матрице с желаемым текстом
        // ?л¤ форматированного вывода можно также использовать функцию font_printf
        uint16_t ScrollLines = font_DrawString("Ёлектроника в объективе", ScrollBuff, 140);
        // —кроллим текст по матрице справа налево
        demo_ScrollBuff(ScrollBuff, ScrollLines, 1);
        // —кроллим текст по матрице слева направо
